...
public interface CRUDHandler {
    ...
    default boolean checkUnique(String modelName, String fieldName, Object value, Long id) {
        var baseModelClass = cool.scx.ext.crud.CRUDHelper.getCRUDApiInfo(modelName).baseModelClass;
        cool.scx.ext.crud.CRUDHelper.checkFieldName(baseModelClass, fieldName);
        var baseModelService = cool.scx.ext.crud.CRUDHelper.getBaseModelService(baseModelClass);
    ...
    default BaseModel add(String modelName, Map<String, Object> saveModel) {
        var baseModelClass = cool.scx.ext.crud.CRUDHelper.getCRUDApiInfo(modelName).baseModelClass;
        var baseModelService = cool.scx.ext.crud.CRUDHelper.getBaseModelService(baseModelClass);
        var realObject = cool.scx.ext.crud.CRUDHelper.mapToBaseModel(saveModel, baseModelClass);
     ...
     * @return 列表数据
     */
    default cool.scx.ext.crud.CRUDListResult list(String modelName, CRUDListParam crudListParam) {
        var baseModelClass = cool.scx.ext.crud.CRUDHelper.getCRUDApiInfo(modelName).baseModelClass;
