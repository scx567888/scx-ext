package cool.scx.ext.config_manager.test;
...
import cool.scx.ext.config_manager.ConfigManagerModule;
 ...
 * @since 1.3.14
 */
public class ConfigManagerTestModule extends ScxModule {
    ...
    public static void runModule() {
        Scx.builder()
                .setMainClass(ConfigManagerTestModule.class)
                .addModule(
                        new ConfigManagerTestModule(),
                        new ConfigManagerModule(),
                        new WSModule(),
                        new AuthModule())
